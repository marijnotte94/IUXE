...
<Package name="storymode" format_version="4">
    ...
    <Dialogs>
        ...
        <Dialog name="settings" src="settings/settings.dlg" />
        <Dialog name="pepper.generic.ask.understood" src="pepper.generic.ask.understood/pepper.generic.ask.understood.dlg" />
        <Dialog name="pepper.generic.ask.notunderstood" src="pepper.generic.ask.notunderstood/pepper.generic.ask.notunderstood.dlg" />
        <Dialog name="pepper.intro.greetings" src="pepper.intro.greetings/pepper.intro.greetings.dlg" />
        <Dialog name="pepper.intro.askname" src="pepper.intro.askname/pepper.intro.askname.dlg" />
        <Dialog name="pepper.intro.welcome" src="pepper.intro.welcome/pepper.intro.welcome.dlg" />
        <Dialog name="pepper.intro.procedure" src="pepper.intro.procedure/pepper.intro.procedure.dlg" />
        <Dialog name="pepper.intro.introduction" src="pepper.intro.introduction/pepper.intro.introduction.dlg" />
        <Dialog name="pepper.generic.callnurse" src="pepper.generic.callnurse/pepper.generic.callnurse.dlg" />
        <Dialog name="pepper.generic.compliment" src="pepper.generic.compliment/pepper.generic.compliment.dlg" />
        <Dialog name="pepper.prom.cananswer" src="pepper.prom.cananswer/pepper.prom.cananswer.dlg" />
        ...
        <Dialog name="pepper.prom.inter11" src="pepper.prom.inter11/pepper.prom.inter11.dlg" />
        <Dialog name="pepper.prom.inter0" src="pepper.prom.inter0/pepper.prom.inter0.dlg" />
        <Dialog name="pepper.intro.explanationstory" src="pepper.intro.explanationstory/pepper.intro.explanationstory.dlg" />
    </Dialogs>
    <Resources>
    ...
    <Topics>
        ...
        <Topic name="pepper.prom.inter1_dun" src="pepper.prom.inter1/pepper.prom.inter1_dun.top" topicName="pepper.prom.inter1" language="nl_NL" />
        ...
        <Topic name="constants" src="pepper.generic.exclamation.positive/constants.top" topicName="values" language="nl_NL" />
        <Topic name="constants" src="pepper.intro.askname/constants.top" topicName="values" language="nl_NL" />
        <Topic name="constants" src="pepper.intro.greetings/constants.top" topicName="values" language="nl_NL" />
        ...
        <Topic name="pepper.prom.inter11_dun" src="pepper.prom.inter11/pepper.prom.inter11_dun.top" topicName="pepper.prom.inter11" language="nl_NL" />
        <Topic name="pepper.prom.inter0_dun" src="pepper.prom.inter0/pepper.prom.inter0_dun.top" topicName="pepper.prom.inter0" language="nl_NL" />
        <Topic name="pepper.intro.explanationstory_dun" src="pepper.intro.explanationstory/pepper.intro.explanationstory_dun.top" topicName="pepper.intro.explanationstory" language="nl_NL" />
    </Topics>
    <IgnoredPaths />
